...
class ModelPrediction(models.Model):
    srf_de_vie = models.IntegerField(default=0,validators=[MinValueValidator(0)])
    chambres = models.IntegerField(default=0,validators=[MinValueValidator(0)])
    ...
    sd_bain = models.FloatField(default=0.0)
